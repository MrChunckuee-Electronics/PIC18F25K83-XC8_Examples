...
_Bool LED8_Status = 0;
_Bool LED9_Status = 0;
_Bool LED10_Status = 0;
_Bool LED11_Status = 0;
_Bool LED12_Status = 0;
# 38 "mcu.c"
void SYSTEM_Initialize(void){
    MCU_Initialize();
...
void RTCC_Enable(void){
    ...
    TIMER0_OVR_FLAG = 0;
    counterTMR0 = 0;
    ((void)(TMR0H=((63536)>>8),TMR0L=((63536)&0xFF)));
}
# 209 "mcu.c"
void RTCC_Update(void){
    if(TIMER0_OVR_FLAG){
...
# 227 "mcu.c"
void MCU_ADCTest(void){
    adcValue = ADC_GetSingleConversion(0b001100);
    if(adcValue < 500){
        LED1_Status = 0;
        LED2_Status = 0;
        LED3_Status = 0;
