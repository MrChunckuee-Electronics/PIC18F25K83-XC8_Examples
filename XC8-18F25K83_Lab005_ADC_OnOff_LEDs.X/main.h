...
#define GPx_Output3_TRIS                 TRISBbits.TRISB3
#define GPx_Output3_LAT                  LATBbits.LATB3
#define GPx_Output3_SetHigh()            do { GPx_Output3_LAT = 1; } while(0)
#define GPx_Output3_SetLow()             do { GPx_Output3_LAT = 0; } while(0)
#define GPx_Output3_SetDigitalInput()    do { GPx_Output3_TRIS = 1; } while(0)
#define GPx_Output3_SetDigitalOutput()   do { GPx_Output3_TRIS = 0; } while(0)
    
/*********** A N A L O G   P O R T   D E F I N E S ***************************/
#define channel_ANB4_voltagePotentiometer_GetValue()     0b001100
