...
void main(void) {
    ...
    LCD_Initialize();
    while(1){
        sensor_adcVoltage = ADC_GetSingleConversion(0b010111);
        sensor_sumVoltage += sensor_adcVoltage;
        sensor_avgCounter ++;
        if(sensor_avgCounter > 10){
        ...
        if(sensor_ready){
            ...
            do { if ( 0 == 0 ) { LCD_Command(0x80 + 14); } else if ( 0 == 1 ) { LCD_Command(0xC0 + 14); } else if ( 0 == 2 ) { LCD_Command(0x94 + 14); } else if ( 0 == 3 ) { LCD_Command(0xD4 + 14); } } while(0);
            LCD_putc('V');
            sensor_ready = 0;
        }
    }
...
void DISPLAY_ShowFloatValue(float value, uint8_t start_row, uint8_t start_col) {
    ...
    if (num_integer_digits >= 6){
        num_decimal_digits = 0;
    } else {
        num_decimal_digits = 6 - num_integer_digits;
    }
    ...
    for (int j = 0; j < 6; j++) {
        ...
        if (digit_value != 0 || (digit_index == units_index) || drawing_active) {
            ...
            if (digit_index == units_index - 1 && units_index > 0) {
                do { if ( start_row == 0 ) { LCD_Command(0x80 + current_col); } else if ( start_row == 1 ) { LCD_Command(0xC0 + current_col); } else if ( start_row == 2 ) { LCD_Command(0x94 + current_col); } else if ( start_row == 3 ) { LCD_Command(0xD4 + current_col); } } while(0);
                LCD_putc(254);
                do { if ( start_row+1 == 0 ) { LCD_Command(0x80 + current_col); } else if ( start_row+1 == 1 ) { LCD_Command(0xC0 + current_col); } else if ( start_row+1 == 2 ) { LCD_Command(0x94 + current_col); } else if ( start_row+1 == 3 ) { LCD_Command(0xD4 + current_col); } } while(0);
                LCD_putc(223);
                current_col += 1;
            }
