...
const uint8_t tron_bold_chars[8][8] = {
    {0b11111, 0b11000, 0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b00000},
    {0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b11000, 0b11111},
    {0b11111, 0b00111, 0b00111, 0b00111, 0b00111, 0b00111, 0b00111, 0b00111},
    {0b11111, 0b11100, 0b11100, 0b11100, 0b11100, 0b11100, 0b11100, 0b11111},
    {0b11111, 0b11100, 0b11100, 0b11100, 0b11100, 0b11100, 0b11100, 0b11100},
    {0b11100, 0b11100, 0b11100, 0b11100, 0b11100, 0b11100, 0b11100, 0b11100},
    {0b11111, 0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b11111},
    {0b11100, 0b11100, 0b11100, 0b11100, 0b11100, 0b11100, 0b11100, 0b11111}
};
...
const uint8_t square_four_chars[8][8] = {
    {0b11111,0b11111,0b11100,0b11100,0b00000,0b00000,0b00000,0b00000},
    {0b00000,0b00000,0b00000,0b00000,0b11100,0b11100,0b11111,0b11111},
    {0b11111,0b11111,0b01111,0b01111,0b01111,0b01111,0b11111,0b11111},
    {0b11111,0b11111,0b11110,0b11110,0b11110,0b11110,0b11111,0b11111},
    {0b00001,0b00011,0b00111,0b01111,0b00000,0b00000,0b00000,0b00000},
    {0b11110,0b11110,0b11110,0b11110,0b11110,0b11110,0b11110,0b11110},
    {0b11111,0b11111,0b00000,0b00000,0b00000,0b00000,0b11111,0b11111},
    {0b11110,0b11110,0b11110,0b11110,0b11110,0b11110,0b11111,0b11111}
};
...
# 150 "LCD_BIGDigits.c"
void LCD_DrawBigDigit(uint8_t digit, uint8_t xpos, uint8_t ypos){
    if (digit > 9 || current_digits == ((void*)0)) return;

    do { if ( xpos == 0 ) { LCD_Command(0x80 + ypos); } else if ( xpos == 1 ) { LCD_Command(0xC0 + ypos); } else if ( xpos == 2 ) { LCD_Command(0x94 + ypos); } else if ( xpos == 3 ) { LCD_Command(0xD4 + ypos); } } while(0);
    LCD_putc(current_digits[digit][0]);
    LCD_putc(current_digits[digit][1]);

    do { if ( xpos+1 == 0 ) { LCD_Command(0x80 + ypos); } else if ( xpos+1 == 1 ) { LCD_Command(0xC0 + ypos); } else if ( xpos+1 == 2 ) { LCD_Command(0x94 + ypos); } else if ( xpos+1 == 3 ) { LCD_Command(0xD4 + ypos); } } while(0);
